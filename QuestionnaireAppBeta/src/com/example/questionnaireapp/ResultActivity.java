...
public class ResultActivity extends Activity {
	...
	private enum Characters { Plywood, Jar_Jar_Binks,
		God, Blair_Witch, Crazy_Eyes, James_Bond, Batman,
		Leatherface, Lassie, Xena, Generic_Damsel,
		Bernadette; }
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		if (id == R.id.share){
			...
			shareIntent.putExtra(Intent.EXTRA_TEXT, "My ideal date is "+ value +" what's yours?  http://linkofapphere.com ");
			startActivity(Intent.createChooser(shareIntent, "Share your thoughts"));
		}
		//
		if( id == R.id.imdb){
			final String link = imdblink;
			Toast.makeText(this, "Opening stalk page.. : "+link, Toast.LENGTH_SHORT).show();
	...
	private void initVariables(){
		...
		case Blair_Witch:
			...
			Toast.makeText(this, value, Toast.LENGTH_LONG).show();
			//t.setText(value + " spiked your drink and you couldn't remember what you did");
			break;
		case Crazy_Eyes:
			images = new int[2];
		...
		case Batman:
			...
			Toast.makeText(this,  value, Toast.LENGTH_LONG).show();
			//t.setText("you had ice cream with " + value + " and shared funny childhood stories");
			break;	
		case Leatherface:
			images = new int[2];
			images[0]= R.drawable.character7;
...
//		d.setText(description);
	...
	public void share(View view){
		...
		shareIntent.setAction(Intent.ACTION_SEND);
		shareIntent.setType("text/plain");
		shareIntent.putExtra(Intent.EXTRA_TEXT, "My ideal date is "+ value +" tell me yours :) http://linkofapphere.com ");
		startActivity(Intent.createChooser(shareIntent, "Share your thoughts"));
